package br.com.zup.pontointeligente.dtos
...
data class CadastroPjDto(
        ...
        @get:Length(min = 2, max = 200, message = "Nome deve conter entre 3 e 200 caracteres.")
        val nome: String = "",
        ...
        @get:Length(min = 5, max = 200, message = "Razão soial deve conter entre 5 e 200 caracteres.")
