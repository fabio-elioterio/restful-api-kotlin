...
import br.com.zup.pontointeligente.repositories.LancamentoRepository
...
class LancamentoServiceTest {
    ...
    private fun lancamento(): Lancamento = Lancamento(Date(), TipoEnum.INCIO_TRABALHO, id, "Codando Kotlin", "HOMEOFFICE")
}